...
export default [
  createSubmission({ title: "Ploughshares", journalURL: "https://www.pshares.org/", submitURL: "https://www.pshares.org/submission-manager", status: "ACCEPTED", tags: ["Poetry", "Contest", "Print Version", "High Volume"], closeDate: moment().add(1, 'days') }),
  createSubmission({ title: "Ploughshares", journalURL: "https://www.pshares.org/", submitURL: "https://www.pshares.org/submission-manager", status: "REJECTED", tags: ["Poetry", "Contest", "Print Version", "High Volume"], closeDate: moment().add(1, 'days') }),
  createSubmission({ title: "Ploughshares", journalURL: "https://www.pshares.org/", submitURL: "https://www.pshares.org/submission-manager", status: "REJECTED", tags: ["Poetry", "Contest", "Print Version", "High Volume"], closeDate: moment().add(1, 'days') }),
  createSubmission({ title: "Ploughshares", journalURL: "https://www.pshares.org/", submitURL: "https://www.pshares.org/submission-manager", status: "READY_TO_SUBMIT", tags: ["Poetry", "Contest", "Print Version", "High Volume"], closeDate: moment().add(1, 'days') }),
